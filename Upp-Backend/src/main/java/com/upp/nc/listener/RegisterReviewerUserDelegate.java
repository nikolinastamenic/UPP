...
public class RegisterReviewerUserDelegate implements JavaDelegate {
    ...
    @Autowired
    public RegisterReviewerUserDelegate(MagazineRepository magazineRepository, IdentityService identityService, RuntimeService runtimeService, RepositoryService repositoryService, TaskService taskService, FormService formService, UserRepository userRepository) {
