...
@Service("sendMailWorkRejected")
public class SendMailWorkRejected implements JavaDelegate {
    private final IdentityService identityService;
    private final EmailService emailService;

    public SendMailWorkRejected(IdentityService identityService, EmailService emailService) {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        message.append("Rad je odbijen iz tehnickih razloga!");
        message.append("\n\n");
